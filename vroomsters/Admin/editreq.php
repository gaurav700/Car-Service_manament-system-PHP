...
session_start();
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  $sql = "UPDATE registration_tb SET r_login_id = '$rid', r_name = '$rname', r_email = '$remail' WHERE r_login_id = '$rid'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM registration_tb WHERE r_login_id = {$_REQUEST['id']}";
