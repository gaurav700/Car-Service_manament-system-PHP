...
if(isset($_REQUEST['reqsubmit'])){
 ...
 if(($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "") || ($_REQUEST['r_password'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $sql = "INSERT INTO registration_tb (r_name, r_email, r_password) VALUES ('$rname', '$rEmail', '$rPassword')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-success" id="reqsubmit" name="reqsubmit">Submit</button>
